...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Your Life Dojo is an AI Life Coach application that helps users track habits, manage goals, journal reflections, and monitor progress." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Lovable App" },
      { name: "twitter:description", content: "Your Life Dojo is an AI Life Coach application that helps users track habits, manage goals, journal reflections, and monitor progress." },
